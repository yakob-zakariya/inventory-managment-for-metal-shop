...
class PayablesRelationManager extends RelationManager
{
    protected static string $relationship = 'payables';

    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                // Payables are created automatically from credit purchases
            ]);
    }
        ...
        return $table
            ...
            ->columns([
                TextColumn::make('purchase.id')
                    ->label('Purchase #')
                    ->url(fn ($record) => $record->purchase ? route('filament.admin.resources.purchases.edit', ['record' => $record->purchase]) : null)
                    ->sortable(),
